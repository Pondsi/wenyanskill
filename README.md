...
```bash
openclaw skills install @pondsi/wenyanskill
```
...
| 智能体 | 接入方法 |
|--------|----------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`，对 AI 说「切换三国风3」即可 |
...
| 智慧體 | 接入方法 |
|--------|----------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`，對 AI 說「切換三國風3」 |
...
| Agent | Integration |
|-------|-------------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`, then tell the AI "Switch to Sanguo 3" |
...
| エージェント | 統合方法 |
|--------------|----------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`、AIに「三國風3に切替」と言う |
...
| 에이전트 | 통합 방법 |
|----------|----------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`, AI 에게 "삼국풍3으로 전환" |
...
| Agent | Intégration |
|-------|-------------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`, dire à l'AI "Passer en Sanguo 3" |
...
| Aginto | Integraĵo |
|--------|-----------|
| **OpenClaw** | `openclaw skills install @pondsi/wenyanskill`, diri al la AI "Ŝanĝi al Sanguo 3" |
